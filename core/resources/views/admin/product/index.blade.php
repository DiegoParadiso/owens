...
@section('css')
    ...
    <style>
        ...
        .custom-input:focus {
            ...
            box-shadow: 0 0 8px rgba(223, 15, 19, 0.5);
        }
...
@section('content')
            ...
            <div class="modal-content custom-modal">
                ...
                <form id="form-tambah-stok" method="post">
                    <div class="modal-body">
                        ...
                        <label for="nilaiTambahStok" class="form-label">Cantidad de Stock</label>
                        <input type="number" name="stock" id="nilaiTambahStok" class="form-control custom-input"
                            required>
                    </div>
    ...
    <div class="container-fluid pt-4 px-4">
        ...
        <div class="row bg-white rounded mx-0">
            <div class="col-12">
                <button type="button" class="btn btn-primary mt-3 mb-3" id="btnCetakLabel">Imprimir Etiquetas</button>
                <div class="bg-white rounded p-4">
                    <h6 class="mb-4 d-flex justify-content-between align-items-center">
                        {{ $title }}
                        <a href="{{ route('product.create') }}" class="btn btn-sm btn-primary">Agregar Producto Individual</a>
                    </h6>
                    ...
                    <table class="table text-start align-middle table-bordered table-hover mb-0">
                        ...
                        <tbody>
                            ...
                            @empty
                                <tr>
                                    <td colspan="6" class="text-center">No hay datos de productos</td>
                                </tr>
                            @endforelse
                        </tbody>
                    </table>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#form-tambah-stok').submit(function(e) {
                ...
                $.ajax({
                    type: "PUT",
                    url: "{{ route('product.addStock', ':id') }}".replace(':id', $('#id_produk')
                        .val()), // Ganti ID produk
                    data: dataForm,
                    dataType: "json",
                        ...
                        Swal.fire({
                            ...
                            if (result.isConfirmed) {
                                window.location.href =
                                    "{{ route('product.index') }}"; // Redirect setelah sukses
                            }
                        })
            ...
            $.ajax({
                ...
                error: function(data) {
                    Swal.fire({
                        icon: 'error',
                        title: 'Error',
                        text: 'Por favor, selecciona productos para imprimir etiquetas',
                        confirmButtonText: 'Ok'
                    })
                }
            })
