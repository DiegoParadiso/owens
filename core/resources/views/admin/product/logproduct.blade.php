            ...
            <div class="col-12">
                <div class="bg-white rounded h-100 p-4">
                    <h6 class="mb-4 d-flex justify-content-between align-items-center">
                        {{ $title }}
                        <a href="{{ route('product.create') }}" class="btn btn-sm btn-primary">Agregar</a>
                    </h6>
                    ...
                    <table class="table table-bordered table-responsive text-center">
                        <thead>
                            <tr>
                                ...
                                <th scope="col">Nombre <svg xmlns="http://www.w3.org/2000/svg" data-toggle="tooltip"
                                        data-placement="top"
                                        title="El nombre mostrado se basa en el usuario que agregó el producto por primera vez, no en el usuario que realizó la adición o reducción de stock"
                        ...
                        <tbody>
                            ...
                            @empty
                                <tr>
                                    <td colspan="5">No hay datos de historial de productos</td>
                                </tr>
                            @endforelse
                        </tbody>
                    </table>
